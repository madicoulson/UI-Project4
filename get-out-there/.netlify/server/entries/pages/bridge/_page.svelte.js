...
function _page($$payload, $$props) {
  push();
  let currentAttending = 203;
  let currentInterest = 108;
  let isAttending = false;
  let isInterested = false;
  $$payload.out += `<div class="background svelte-gisq7w"><div class="box svelte-gisq7w">`;
  Header($$payload, {
    children: ($$payload2) => {
      $$payload2.out += `<!---->Walk the Roebling Bridge`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----> `;
  Header($$payload, {
    children: ($$payload2) => {
      $$payload2.out += `<!---->All Year`;
    },
    $$slots: { default: true }
  });
  $$payload.out += `<!----></div> <div class="info svelte-gisq7w"><img${attr("src", bridge)} alt="Roebling Bridge" class="svelte-gisq7w"> <div class="text-info svelte-gisq7w">`;
  Text($$payload, {
    type: "bold",
    children: ($$payload2) => {
      $$payload2.out += `<!---->Walk across Cincinnati's historic Roebling Bridge across the Ohio River. This bridge
                connects downtown Cincinnati to Covington, Kentucky. It is open year round.`;
    },
    $$slots: { default: true }
  });
